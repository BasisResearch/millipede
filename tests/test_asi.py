...
def test_linear_correlated(precompute_XX, include_intercept, prior='isotropic',
                           N=128, P=16, intercept=2.34, report_frequency=200,
                           T=2000, T_burnin=500, seed=1):
    ...
    samples = []
    sampler = ASISampler(X, Y, precompute_XX=precompute_XX, prior=prior,
    ...
    selector = ASIVariableSelector(dataframe, 'response', tau=0.01, c=100.0,
